...
*/}}
{{- define "mautrix-telegram.imageTag" -}}
...
*/}}
{{- define "mautrix-telegram.serviceurl" -}}
{{- .Values.appservice.address | default (printf "http://%s:%d" (include "mautrix-telegram.fullname" .) (int .Values.service.port) ) -}}
{{- end }}
